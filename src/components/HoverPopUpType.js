...
const HoverPopUpType = (props) => {
    ...
    const planetTypeInfo = {
        ...
        Neptunian: 'These exoplanets are similar in size to Neptune or Uranus in our solar system. Neptunian planets typically have hydrogen and helium-dominated atmospheres with cores of rock and heavier metals',
        Super_Earth: 'A class of planets unlike any in our solar system, Super Earths are more massive than Earth, yet are lighter than ice giants like Neptune and Uranus, and can be made of gas, rock or a combination of both. They are anywhere between two to ten times the size of Earth and its mass.',
